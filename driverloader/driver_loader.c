...
#define SERVICE_NAME	"MyProtectionDriver3"
#define DEVICE_NAME		"\\\\.\\MyProtectionDriver3"
...
//	GetModuleFileName(MAX_PATH, driver_file);
#ifndef __GNUC__			//Use strcat_s for Visual Studio, but not for gcc
	//strcat_s(driver_file, MAX_PATH, "\\protection.sys");
	strcat_s(driver_file, MAX_PATH, "E:\\Kernel_Mode_Process_Protection\\x64\\Win8.1Debug\\protection.sys");
#else
